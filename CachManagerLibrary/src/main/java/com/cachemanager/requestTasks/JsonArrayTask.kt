...
class JsonArrayTask(private val method: DownLoadManager.Method, private val mUrl: String, private val params: ArrayList<RequestParams>, private val headers: ArrayList<HeaderParams>, private val callback: HttpListener<JSONArray>) : Task<String, Void, JSONArray>() {
    ...
    override fun doInBackground(vararg urls: String): JSONArray? {
        try {
            ...
            val json = JSONArray(response.dataAsString)
